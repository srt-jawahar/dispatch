...
from .views import TruckListCreateView, TruckUpdateRetrieveDeleteView, TruckAvailabilityListCreateView, TruckAvailibilityUpdateRetrieveDeleteView,\
    GetTruckAvailability, GetTrucksAvailabilityDetailsView
...
urlpatterns = [
    ...
    path('get_truck_availability_list/', GetTrucksAvailabilityDetailsView.as_view(), name='truck_availability_status')
]
